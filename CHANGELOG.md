...
- Fixed issue with plugin edition not defined [#25](https://github.com/ryssbowh/craft-activity/issues/25)

## 2.4.2 - 2024-07-20

### Fixed

- Fixed issue that occured when hiding labels [#24](https://github.com/ryssbowh/craft-activity/issues/24)
